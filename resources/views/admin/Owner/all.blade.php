        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Owners</h2>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel33">Owner </h4>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>


                                    <form method="post" action="{{ route('store.owner') }}">
                                        @csrf
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form method="get" action="{{ route('find.owner') }}">
                    @csrf
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="card-body">
                    <div class="demo-inline-spacing">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" >Find Owners</button>
                        </div>
                    </div>
                </div>
...
<!-- Basic Dropdown End -->
 ...
 <div class="col-lg-12 col-12">
    <div class="card card-statistics">
        <div class="card-header">
            <h4 class="card-title">Owner Analytics</h4>
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="d-flex flex-row">
                        ...
                        <div class="my-auto">
                            ...
                            <p class="card-text font-small-3 mb-0">Owners</p>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <div class="row" id="table-hover-row">
    <div class="col-12">
        <div class="card">
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <div class="avatar bg-primary">
                                        <div class="avatar-content">
                                            <a href="{{ URL::to('view/owner/'.$row->id) }}">  <i data-feather="view" class="avatar-icon"></i> </a>
                                        </div>
                                    </div>

                                    <div class="avatar bg-primary">
                                        <div class="avatar-content">
                                            <a href="{{ URL::to('edit/owner/'.$row->id) }}">  <i data-feather="edit" class="avatar-icon"></i> </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="avatar bg-danger">
                                        <div class="avatar-content">
                                            <a href="{{ URL::to('delete/owner/'.$row->id) }}"> <i data-feather="delete" class="avatar-icon"></i></a>
                                        </div>
                                    </div>
            ...
            <div class="pagination pagination-lg justify-content-center mt-2" >{!! $owner->onEachSide(1)->links() !!}</div>
