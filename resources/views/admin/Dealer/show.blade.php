        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Dealer Details</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <br> <strong> {{ $dealer->voms_id }} </strong>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <br> <strong> {{ $dealer->first_name }} </strong>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <br> <strong> {{ $dealer->last_name }} </strong>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <br> <strong> {{ $dealer->date_of_birth }} </strong>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <br> <strong> {{ $dealer->address1 }} </strong>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <br> <strong> {{ $dealer->address2 }} </strong>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <br> <strong> {{ $dealer->phone_number }} </strong>
                                </div>
                            </div>
...
<div class="content-header-left col-md-9 col-12 mb-2">
    <div class="row breadcrumbs-top">
        <div class="col-12">
            <h2 class="content-header-title float-start mb-0">Vehicles Managed</h2>
            <div class="breadcrumb-wrapper">
                ...
                <div class="card-body">
                    <form class="form">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="last-name-column">Current Owner</label>
                                    <br> <strong> {{ $von->owner_voms_id }} </strong>
                                </div>
                            </div>
