...
<body class="horizontal-layout horizontal-menu  navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="">
        ...
        <div class="navbar-header d-xl-block d-none">
            <ul class="nav navbar-nav">
                <li class="nav-item"><a class="navbar-brand" href="../../../html/ltr/horizontal-menu-template/index.html"><span class="brand-logo">
                        ...
                        <h2 class="brand-text mb-0">VOMS</h2>
                    </a></li>
            </ul>
        </div>
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">{{$username}}</span></div><span class="avatar"><img class="round" src="{{  asset('public/backend/app-assets/images/portrait/small/john.jpg')  }}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user"><a class="dropdown-item" href=><i class="me-50" data-feather="user"></i> Profile</a><a class="dropdown-item" href= {{ URL::to('/admin/logout') }} ><i class="me-50" data-feather="mail"></i> Logout</a>
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link d-flex align-items-center" href="index.html" data-bs-toggle="dropdown"><i data-feather="home"></i><span data-i18n="Dashboards">Dashboard</span></a>
                        <ul class="dropdown-menu" data-bs-popper="none">
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center" href={{ URL::to('/admin/dashboard') }} data-bs-toggle="" data-i18n="Analytics"><i data-feather="activity"></i><span data-i18n="Analytics">Analytics</span></a>
                            </li>
                    ...
                    <!-- Vehicles-->
                    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link d-flex align-items-center" href="#" data-bs-toggle="dropdown"><i data-feather="package"></i><span data-i18n="Apps">VEHICLES</span></a>
                        <ul class="dropdown-menu" data-bs-popper="none">
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center" href={{ URL::to('/admin/vehicle/all') }} data-bs-toggle="" data-i18n="Email"><i data-feather="mail"></i><span data-i18n="Email">MY VEHICLES</span></a>
                            </li>
                        </ul>
                    </li>
                     ...
                     <!-- Certificates-->
                     <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link d-flex align-items-center" href="#" data-bs-toggle="dropdown"><i data-feather="package"></i><span data-i18n="Apps">CERTIFICATES</span></a>
                        <ul class="dropdown-menu" data-bs-popper="none">
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center" href={{ URL::to('/admin/certificate/all') }} data-bs-toggle="" data-i18n="Email"><i data-feather="mail"></i><span data-i18n="Email">MY CERTIFICATES</span></a>
                            </li>
                        </ul>
                    </li>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2022<a class="ms-25" href="#" target="_blank">JPMB TECHNOLOGIES</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span></p>
    </footer>
